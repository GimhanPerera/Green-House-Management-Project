...
const sensors=[
    {
        ...
        type:"Temperature",
        unit:"°C",
        values:[//values are sorted by dateTime values randomly between 25 to 30. differ according to hour of day. noon is pewak time
    ...
    },
    {
        ...
        "unit": "Status",
        "values": [
            {"dateTime": "2024-06-01 00:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 01:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 02:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 03:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 04:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 05:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 06:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 07:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 08:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 09:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 10:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 11:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 12:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 13:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 14:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 15:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 16:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 17:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 18:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 19:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 20:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 21:00:00", "value": "Low"}
        ]
    },
    {
        "id": 5,
        ...
        "unit": "Status",
        "values": [
            {"dateTime": "2024-06-01 00:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 01:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 02:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 03:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 04:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 05:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 06:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 07:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 08:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 09:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 10:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 11:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 12:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 13:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 14:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 15:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 16:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 17:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 18:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 19:00:00", "value": "OK"},
            {"dateTime": "2024-06-01 20:00:00", "value": "Low"},
            {"dateTime": "2024-06-01 21:00:00", "value": "OK"}
        ]
    },
    {
        "id": 6,
...
const sensorTypeDescriptions=[
    {
        type:"Temperature",
        image:"https://www.aaaksc.com/wp-content/uploads/2022/06/Temperature-sensor-2.jpg",
        description:"Temperature sensors are used to measure the temperature of air, liquids or solids. They are widely used in industrial and scientific applications."
    },
    {
        type:"Humidity",
        image:"https://static.wixstatic.com/media/d5426d_f173ae229f334a4ba5f52532c011a8aa~mv2.png/v1/fill/w_980,h_552,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/d5426d_f173ae229f334a4ba5f52532c011a8aa~mv2.png",
        description:"Humidity sensors are used to measure the amount of water vapour in the air. They are used in weather stations, greenhouses, and other applications where humidity levels need to be monitored."
    },
    {
        type:"Nutrient Level",
        image:"https://biofeed.com/wp-content/uploads/2021/02/soil-nutrients-600px.jpg",
        description:"Nutrient level sensors are used to measure the concentration of nutrients in a liquid. They are commonly used in hydroponic systems and other applications where nutrient levels need to be monitored."
    },
    {
        type:"Soil pH",
        image:"https://i0.wp.com/deepgreenpermaculture.com/wp-content/uploads/2022/01/soil-ph-scale-scale-2_00x.jpg?ssl=1",
        description:"Soil pH sensors are used to measure the acidity or alkalinity of soil. They are used in agriculture, horticulture, and other applications where soil pH needs to be monitored."
    },
    {
        type:"CO2 Level",
        image:"https://cdn.shopify.com/s/files/1/0019/5952/files/what_co2_level_is_dangerous.png?v=1678825571",
        description:"CO2 level sensors are used to measure the concentration of carbon dioxide in the air. They are used in buildings, greenhouses, and other applications where CO2 levels need to be monitored."
    },
    {
        type:"Soil Moisture",
        image:"https://eos.com/wp-content/uploads/2022/10/soil-moisture-main.jpg",
        description:"Soil moisture sensors are used to measure the amount of water in the soil. They are used in agriculture, horticulture, and other applications where soil moisture levels need to be monitored."
    }
...
const getSensors=()=>{
    ...
    sensors.forEach(sensor=>{
        registeredSensors.push({id:sensor.id,name:sensor.name,type:sensor.type,description:getSensorTypeDescription(sensor.type),image:sensorTypeDescriptions.find(sensorType=>sensorType.type===sensor.type).image})
    })
...
const getSensorTypeDescription=(type)=>{
    return sensorTypeDescriptions.find(sensorType=>sensorType.type===type).description
}
...
export {getSensorByType,getSensors,getSensorById,getSensorValues,getSensorTypeDescription}